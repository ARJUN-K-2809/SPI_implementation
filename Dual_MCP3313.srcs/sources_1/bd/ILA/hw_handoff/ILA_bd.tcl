...
CONFIG.CLK_DOMAIN {ILA_processing_system7_0_0_FCLK_CLK0} \
CONFIG.FREQ_HZ {50000000} \
 ] $i_Clk
  set i_SPI_MISO_1 [ create_bd_port -dir I i_SPI_MISO_1 ]
  set i_SPI_MISO_2 [ create_bd_port -dir I i_SPI_MISO_2 ]
  set o_SPI_CS1_n [ create_bd_port -dir O o_SPI_CS1_n ]
  set o_SPI_CS2_n [ create_bd_port -dir O o_SPI_CS2_n ]
  set o_SPI_MOSI [ create_bd_port -dir O o_SPI_MOSI ]
  set o_SPI_SCLK1 [ create_bd_port -dir O o_SPI_SCLK1 ]
  set o_SPI_SCLK2 [ create_bd_port -dir O o_SPI_SCLK2 ]

  # Create instance: Dual_MCP3313_0, and set properties
  set block_name Dual_MCP3313
  set block_cell_name Dual_MCP3313_0
  if { [catch {set Dual_MCP3313_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $Dual_MCP3313_0 eq "" } {
...
CONFIG.PCW_WDT_WDT_IO.VALUE_SRC {DEFAULT} \
  ...
  connect_bd_net -net Dual_MCP3313_0_o_ADC1_Data [get_bd_pins Dual_MCP3313_0/o_ADC1_Data] [get_bd_pins ila_0/probe0]
  connect_bd_net -net Dual_MCP3313_0_o_ADC2_Data [get_bd_pins Dual_MCP3313_0/o_ADC2_Data] [get_bd_pins ila_0/probe1]
  connect_bd_net -net Dual_MCP3313_0_o_Data_Valid [get_bd_pins Dual_MCP3313_0/o_Data_Valid] [get_bd_pins ila_0/probe2]
  connect_bd_net -net Dual_MCP3313_0_o_SPI_CS1_n [get_bd_ports o_SPI_CS1_n] [get_bd_pins Dual_MCP3313_0/o_SPI_CS1_n]
  connect_bd_net -net Dual_MCP3313_0_o_SPI_CS2_n [get_bd_ports o_SPI_CS2_n] [get_bd_pins Dual_MCP3313_0/o_SPI_CS2_n]
  connect_bd_net -net Dual_MCP3313_0_o_SPI_MOSI [get_bd_ports o_SPI_MOSI] [get_bd_pins Dual_MCP3313_0/o_SPI_MOSI]
  connect_bd_net -net Dual_MCP3313_0_o_SPI_SCLK1 [get_bd_ports o_SPI_SCLK1] [get_bd_pins Dual_MCP3313_0/o_SPI_SCLK1]
  connect_bd_net -net Dual_MCP3313_0_o_SPI_SCLK2 [get_bd_ports o_SPI_SCLK2] [get_bd_pins Dual_MCP3313_0/o_SPI_SCLK2]
  connect_bd_net -net i_Clk_1 [get_bd_ports i_Clk] [get_bd_pins Dual_MCP3313_0/i_Clk] [get_bd_pins ila_0/clk] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK]
  connect_bd_net -net i_SPI_MISO_1_1 [get_bd_ports i_SPI_MISO_1] [get_bd_pins Dual_MCP3313_0/i_SPI_MISO_1]
  connect_bd_net -net i_SPI_MISO_2_1 [get_bd_ports i_SPI_MISO_2] [get_bd_pins Dual_MCP3313_0/i_SPI_MISO_2]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins Dual_MCP3313_0/i_Rst_L] [get_bd_pins processing_system7_0/FCLK_RESET0_N]
  connect_bd_net -net xlconstant_0_dout [get_bd_pins Dual_MCP3313_0/i_Start_Conversion] [get_bd_pins xlconstant_0/dout]
...
#  -string -flagsOSRD
preplace port o_SPI_SCLK2 -pg 1 -y 400 -defaultsOSRD
preplace port DDR -pg 1 -y 110 -defaultsOSRD
preplace port i_Clk -pg 1 -y 340 -defaultsOSRD
preplace port o_SPI_CS1_n -pg 1 -y 420 -defaultsOSRD
preplace port FIXED_IO -pg 1 -y 130 -defaultsOSRD
preplace port o_SPI_CS2_n -pg 1 -y 440 -defaultsOSRD
preplace port o_SPI_MOSI -pg 1 -y 460 -defaultsOSRD
preplace port i_SPI_MISO_1 -pg 1 -y 400 -defaultsOSRD
preplace port i_SPI_MISO_2 -pg 1 -y 420 -defaultsOSRD
preplace port o_SPI_SCLK1 -pg 1 -y 380 -defaultsOSRD
preplace inst xlconstant_0 -pg 1 -lvl 1 -y 370 -defaultsOSRD
preplace inst Dual_MCP3313_0 -pg 1 -lvl 2 -y 380 -defaultsOSRD
preplace inst ila_0 -pg 1 -lvl 3 -y 280 -defaultsOSRD
preplace inst processing_system7_0 -pg 1 -lvl 2 -y -10 -defaultsOSRD
preplace netloc processing_system7_0_DDR 1 2 2 NJ -50 540J
preplace netloc i_Clk_1 1 0 3 -260J 250 -130J 250 NJ
preplace netloc Dual_MCP3313_0_o_SPI_CS1_n 1 2 2 NJ 420 NJ
preplace netloc Dual_MCP3313_0_o_SPI_SCLK1 1 2 2 NJ 380 NJ
preplace netloc Dual_MCP3313_0_o_SPI_SCLK2 1 2 2 NJ 400 NJ
preplace netloc processing_system7_0_FCLK_RESET0_N 1 1 2 -120 80 260
preplace netloc Dual_MCP3313_0_o_ADC1_Data 1 2 1 260
preplace netloc Dual_MCP3313_0_o_Data_Valid 1 2 1 270
preplace netloc xlconstant_0_dout 1 1 1 -130
preplace netloc processing_system7_0_FIXED_IO 1 2 2 NJ -30 530J
preplace netloc Dual_MCP3313_0_o_ADC2_Data 1 2 1 280
preplace netloc i_SPI_MISO_1_1 1 0 2 -260J 430 -120J
preplace netloc Dual_MCP3313_0_o_SPI_MOSI 1 2 2 NJ 460 NJ
preplace netloc Dual_MCP3313_0_o_SPI_CS2_n 1 2 2 NJ 440 NJ
preplace netloc i_SPI_MISO_2_1 1 0 2 NJ 420 NJ
levelinfo -pg 1 -280 -190 80 440 620 -top -240 -bot 780
",
}
