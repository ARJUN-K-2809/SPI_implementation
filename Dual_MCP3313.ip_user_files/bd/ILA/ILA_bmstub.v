...
module ILA (
  ...
  (* X_INTERFACE_IGNORE = "true" *)
  output o_SPI_MOSI;
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.I_CLK CLK" *)
  (* X_INTERFACE_MODE = "slave CLK.I_CLK" *)
  (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.I_CLK, FREQ_HZ 50000000, FREQ_TOLERANCE_HZ 0, PHASE 0.000, CLK_DOMAIN ILA_processing_system7_0_0_FCLK_CLK0, INSERT_VIP 0" *)
  input i_Clk;
